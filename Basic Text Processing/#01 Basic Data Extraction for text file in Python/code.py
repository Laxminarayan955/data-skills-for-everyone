...
with open('D:/YT Classes/Python/Text Processing/data-skills-for-everyone/Basic Text Processing/#01 Basic Data Extraction for text file in Python/data/summary.txt', 'r') as file_handle:
